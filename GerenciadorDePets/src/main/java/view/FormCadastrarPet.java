...
public class FormCadastrarPet extends javax.swing.JFrame {
    ...
    private void cadastrarPet(){
        if(verificarCampos()){
            ...
            String dataNascimentp = txtfieldDataNascimento.getText();
            System.out.println(verificaData(dataNascimentp));
            
            // Recuperar ID do usuário que está cadastrando o PET
            
            // Criar instancia de PET e cadastrar no BD
